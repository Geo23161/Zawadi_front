        ...
        <form @submit.prevent="register()" >
          ...
          <div class="form_cont">
            ...
            <div style="padding-top: 1rem">
              <ion-button type="submit" expand="full" color="tertiary"
...
const register = async () => {
  ...
  try {
    ...
    return await show_alert(
      "Numéro incorrect",
      "Verifiez le numéro whatsapp entré"
    );
  }
  ...
  if (res.data["done"]) {
    ...
    if (res.data['result'] == 1){
      show_alert('Email déjà utilisé', 'Cet email a déjà été utilisé par un membre.')
    }
  }
};
